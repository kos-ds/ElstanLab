...
namespace ElstanLab.Pages.IVWPage
{
    public class IVWPageBuilder
    {
        ...
        private Label lblUaP, lblUbP, lblUcP;
        ...
        public IVWPageBuilder(TabPage tabPage)
        {
            page = tabPage;
            Build();
        ...
        private TableLayoutPanel BuildTopPanel()
        {
            ...
            top.Controls.Add(BuildCurrentGroup(), 2, 0);
            top.Controls.Add(BuildVoltageGroupPril(), 1, 0);
            return top;
        }
        ...
        private GroupBox BuildVoltageGroupPril()
        {
            GroupBox gb = new GroupBox();
            gb.Text = "Напряжение приложенное";
            gb.Dock = DockStyle.Fill;
            gb.Font = new Font("Segoe UI", 10, FontStyle.Bold);
            ...
            lblUbP = CreateValueLabel();
            lblUcP = CreateValueLabel();
            t.Controls.Add(lblUaP, 0, 1);
            t.Controls.Add(lblUbP, 1, 1);
            t.Controls.Add(lblUcP, 2, 1);
        ...
        private void AnalyzeRecording()
        {
            ...
            var snap = LabStorage.CurrentIVW;
        ...
        private void OnDataUpdated(MeterPacket p)
        {
            ...
            lblUaP.Text = (p.UL1_AB*3.47826).ToString("F1");
            lblUbP.Text = (p.UL1_BC*3.47826).ToString("F1");
            lblUcP.Text = (p.UL1_CA*3.47826).ToString("F1");
